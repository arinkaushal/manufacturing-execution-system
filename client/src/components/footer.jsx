...
function Footer() {
  ...
  if (location.pathname.includes('/demo') || location.pathname.includes('/workplace')) {
    return null;
  }

  const linkStyle = "text-gray-600 hover:text-gray-900 transition-colors duration-150 font-normal text-sm";
  const socialIconStyle = "w-4 h-4 text-gray-500 hover:text-gray-900 transition-colors duration-150 cursor-pointer";
